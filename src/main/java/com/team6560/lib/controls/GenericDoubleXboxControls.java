package com.team6560.lib.controls;

import edu.wpi.first.wpilibj.XboxController;
import com.team6560.lib.util.NumberStepper;
import com.team6560.lib.util.PovNumberStepper;
...
public class GenericDoubleXboxControls implements GenericControlsIO {
    ...
    public GenericDoubleXboxControls(XboxController driverController, XboxController shooterController, DriveControlsConfig config) {
        ...
        this.speed = new PovNumberStepper(
            new NumberStepper(
                config.speedInitialPercent * config.maxVelocity, 
                config.speedMinPercent * config.maxVelocity,
                config.speedMaxPercent * config.maxVelocity, 
                config.speedStepPercent * config.maxVelocity
            ),
            driverController,
        ...
        this.turnSpeed = new PovNumberStepper(
            new NumberStepper(
                config.turnSpeedInitialPercent * config.maxAngularVelocity, 
                config.turnSpeedMinPercent * config.maxAngularVelocity, 
                config.turnSpeedMaxPercent * config.maxAngularVelocity,
                config.speedStepPercent * config.maxAngularVelocity
            ),
            driverController,
