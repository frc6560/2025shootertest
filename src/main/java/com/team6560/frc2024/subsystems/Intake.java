...
public class Intake extends SubsystemBase {
    ...
    final AnalogInput distanceSensor;

    public Intake() { 
        this.distanceSensor = new AnalogInput(7);
    ...
    /* Get game piece in status */
    public double gamePieceIn() {
        return this.distanceSensor.getVoltage();
    }
}
